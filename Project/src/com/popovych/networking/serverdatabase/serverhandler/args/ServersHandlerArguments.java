...
public class ServersHandlerArguments extends DatabaseWorkerThreadArguments {
    ...
    public ServersHandlerArguments(ServerDatabase serverDatabase, ServerSocket serversSocket) {
