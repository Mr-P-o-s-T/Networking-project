...
public class DatabaseServerHandlerThreadArguments extends DatabaseWorkerThreadArguments {
    ...
    public DatabaseServerHandlerThreadArguments(ServerDatabase database, Socket serverHandlerSocket) {
