...
public class DatabaseClientHandlerThreadArguments extends DatabaseWorkerThreadArguments {
    ...
    public DatabaseClientHandlerThreadArguments(ServerDatabase database, Socket clientHandlerSocket) {
